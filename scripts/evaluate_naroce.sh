...
for eval_dataset in '15min' '30min'; do #'3min' '15min' '30min' '5min'
    for sensor_dataset in 2000; do
        for seed in 0 17; do # 0 17 1243 3674 7341 53 97 103 191 99719
            ...
            python evaluate.py $config $model $sensor_dataset $eval_dataset $seed --nar_dataset $nar_dataset
        done
    done
done
